...
from anak import run_GCN, geomertric_dataset, save_node2vec_emb
from my_utils import Cora, display2screen
from arg_parser import *
from my_utils import Copd
from my_utils import normalize_features, normalize_adj
...
if __name__ == "__main__":
    ...
    #
    # folder = 'output/gene_disease/embedding/node2vec/'
    ...
    # ==============================
    cora_geometric_dataset = geomertric_dataset(cora_feature_graph, x=x, edges_index=edge_index, y=y, split=args.split)
    # cora_geometric_dataset = geomertric_dataset(cora_feature_graph, x=adj, edges_index=edge_index, y=y, split=args.split)
    # cora_geometric_dataset = geomertric_dataset(cora_feature_graph, x=features, edges_index=edge_index, y=y, split=args.split)
    ...
    run_GCN(data=cora_geometric_dataset, emb_name=args.emb_name, time_stamp=args.time_stamp, tuning=args.tuning,
